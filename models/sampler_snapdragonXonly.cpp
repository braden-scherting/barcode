...
// [[Rcpp::export]]
Rcpp::List sampler_snapdragonXonly(int niter, int nthin, int nburn, Rcpp::List dims, Rcpp::List dat, 
  ...
  arma::cube Xi(N, L, niter);
  arma::mat Xiit(N, L, arma::fill::zeros);

  arma::mat des01(N, N, arma::fill::ones);
